	...
	<div id="wrap">
		...
		<div class="leftMeun" id="leftMeun">
			...
			<div class="meun-item meun-item-active">
				<img src="${pageContext.request.contextPath}/images/icon_change_grey.png">学生录入
			</div>
		</div>
            ...
            <div class="tab-content">
            	...
            	<div role="tabpanel" class="tab-pane active" id="sour">
					...
					<div style="padding: 50px 0; margin-top: 50px; background-color: #fff; text-align: right; width: 420px; margin: 50px auto;">
						<form class="form-horizontal" name="addForm" id="addForm" action="${pageContext.request.contextPath}/AddXueSheng" method="post">
							<div class="form-group">
								<label for="sKnot" class="col-xs-4 control-label">学&nbsp;&nbsp;号：</label>
								<div class="col-xs-5">
									<input type="" class="form-control input-sm duiqi" name="xuehao" id="xuehao" placeholder="" style="margin-top: 7px;">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-xs-5">
									<input type="" class="form-control input-sm duiqi" name="banji" id="banji" id="sKnot" placeholder="" style="margin-top: 7px;">
								</div>
							</div>
							<div class="form-group">
...
function Add() {
	...
	if (xuehao == '' || xingming == '' || nianling == '' || banji == '' || loginname == '' || loginpw == '') {
		alert('请填写完整！！！');
	}else {
