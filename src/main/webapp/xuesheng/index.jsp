...
<body>
	<div id="wrap">
		...
		<div class="leftMeun" id="leftMeun">
			<div id="logoDiv">
				<p id="logoP">
					<img id="logo" src="${pageContext.request.contextPath}/images/logo3.png"><span>${xingming }(学生)</span>
				</p>
			</div>
			<div id="personInfor">
				<p id="showtime"></p>
			...
			<div class="meun-item" >
				<a href="xuesheng/xueshengMes.jsp?oldId=${id }&oldName=${xingming }"><img src="${pageContext.request.contextPath}/images/icon_card_grey.png">我的信息</a>
			</div>
			<div class="meun-item">
				<a href="xuesheng/xueshengEdi.jsp?oldId=${id }&oldName=${xingming }"><img src="${pageContext.request.contextPath}/images/icon_rule_grey.png">修改密码</a>
			</div>
			<div class="meun-title">课表信息</div>
			<div class="meun-item">
				<a href="xuesheng/kebiaoSelect.jsp?oldId=${id }&oldName=${xingming }"><img src="${pageContext.request.contextPath}/images/icon_user_grey.png">可选课程</a>
			</div>
			<div class="meun-item">
				<a href="xuesheng/kebiaoMes.jsp?oldId=${id }&oldName=${xingming }"><img src="${pageContext.request.contextPath}/images/icon_user_grey.png">我的选课</a>
			</div>
		</div>
