...
<div class="modal-body">
	<div style="padding: 50px 0; margin-top: 50px; background-color: #fff; text-align: right; width: 420px; margin: 50px auto;">
    	...
    	<center><h4 class="modal-title" id="gridSystemModalLabel">教学管理系统</h4></center>
    	<br>
			<div class="form-group">
				<label for="sKnot" class="col-xs-4 control-label">用户名：</label>
				<div class="col-xs-5">
					<input type="text" class="form-control input-sm duiqi" id="userName" name="userName" placeholder="输入用户名" style="margin-top: 7px;">
				</div>
			</div>
			<div class="form-group">
