		...
		<div id="rightContent">
            ...
            <div class="tab-content">
            	...
            	<div role="tabpanel" class="tab-pane active" id="sour">
                	...
                	DB db = new DB();
                	//创建sql语句
                	String sql = "select * from xuesheng where id=" + oldId;
                	//调用查询方法
                	ps = db.getPs(sql);
                	//接收结果集
                	rs = ps.executeQuery();
					...
					<div style="padding: 50px 0; margin-top: 50px; background-color: #fff; text-align: right; width: 420px; margin: 50px auto;">
						<form class="form-horizontal" name="upForm" id="upForm" action="${pageContext.request.contextPath}/UpAdmin" method="post">
							...
							<div class="form-group">
								<label for="sKnot" class="col-xs-4 control-label">学&nbsp;&nbsp;号：</label>
								<div class="col-xs-5">
									<input type="text" class="form-control input-sm duiqi" value="<%=rs.getString("xuehao") %>" readonly="readonly" placeholder="" style="margin-top: 7px;color:black;">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="sKnot" class="col-xs-4 control-label">班&nbsp;&nbsp;级：</label>
								<div class="col-xs-5">
									<input type="" class="form-control input-sm duiqi" value="<%=rs.getString("banji") %>" name="banji" id="banji" readonly="readonly" placeholder="" style="margin-top: 7px;color:black;">
								</div>
							</div>
							<div class="form-group">
