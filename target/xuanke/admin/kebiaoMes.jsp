	...
	<div id="wrap">
		...
		<div class="leftMeun" id="leftMeun">
			...
			<div class="meun-item  meun-item-active" >
				<img src="${pageContext.request.contextPath}/images/icon_card_grey.png">课表信息
			</div>
			<div class="meun-item" >
					...
					<div class="data-div">
                		...
                		%>
							<div class="row">
								...
								<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
									<button class="btn btn-success btn-xs"><a style="color: white" href="kebiaoAdd.jsp?oldName=<%=oldName%>&oldId=<%=oldId%>">添加</a></button>
									<button class="btn btn-danger btn-xs"><a style="color: white" href="${pageContext.request.contextPath}/DeleKeBiao?id=<%=rs.getInt("id")%>&oldName=<%=oldName%>&oldId=<%=oldId%>">删除</a></button>
								</div>
							</div>
						<%
