	...
	<div id="wrap">
		...
		<div class="leftMeun" id="leftMeun">
			...
			<div class="meun-item meun-item-active" >
				<img src="${pageContext.request.contextPath}/images/icon_user_grey.png">课程信息
			</div>
			<div class="meun-item" >
		...
		<div id="rightContent">
            ...
            <div class="tab-content">
            	...
            	<div role="tabpanel" class="tab-pane active" id="sour">
                	...
                	//sql语句,遍历整个admin表的总数
                	String sql = "select count(*) from kecheng";
                	//调用DB里面的方法
                	ps = db.getPs(sql);       	               	
                	//执行sql语句,并获得返回的结果集
                	rs = ps.executeQuery();
                	...
                	sql = "select * from kecheng order by id desc";
                	begin = (p-1)*size;//当前索引
					...
					<div class="data-div">
						<div class="row tableHeader">
							...
							<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">课程编号</div>
							<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">课程名称</div>
							<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">课时</div>
                		...
                		%>
							<div class="row">
								...
								<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3  levl3">
								...
								<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
									...
									<button class="btn btn-danger btn-xs"><a style="color: white" href="${pageContext.request.contextPath}/DeleKeCheng?id=<%=rs.getInt("id")%>&oldName=<%=oldName%>&oldId=<%=oldId%>">删除</a></button>
								</div>
							</div>
						<%
					...
					<ul class="pagination">
						...
						<li>
							...
							<a href="kechengMes.jsp?oldName=<%=oldName %>&oldId=<%=oldId %>&page=<%=(p-1)%>"><i class="glyphicon glyphicon-menu-left"> </i></a>
							<%
								}
							%>
						</li>
						<li>
							<%
								if(p < page_count){
							%>							
							<a href="kechengMes.jsp?oldName=<%=oldName %>&oldId=<%=oldId %>&page=<%=(p+1)%>"><i class="glyphicon glyphicon-menu-right"> </i></a>
							<%
								}
							%>
						</li>
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<div class="container-fluid">
										<form class="form-horizontal" id="formEdi" action="${pageContext.request.contextPath}/EdiKeCheng" method="post">
											...
											<div class="form-group ">
												<label for="userName" class="col-xs-3 control-label">课程编号：</label>
												<div class="col-xs-8 ">
											...
											<div class="form-group">
												<label for="userPw" class="col-xs-3 control-label">课程名称：</label>
												<div class="col-xs-8 ">
													<input type="" class="form-control input-sm duiqi" name="mingcheng" id="mingcheng" >
												</div>
											</div>
											<div class="form-group">
												<label for="userPw" class="col-xs-3 control-label">课&nbsp;&nbsp;时：</label>
												<div class="col-xs-8 ">
													<input type="" class="form-control input-sm duiqi" name="keshi" id="keshi" >
												</div>
											</div>
										</form>
									</div>
